...
const myVideoBtn = document.querySelector('#my-video-button');
...
const modalTnxsCloseBtns = document.querySelectorAll('.modal-thanks-close-button');
...
modalTnxsCloseBtns.forEach(btn => {
    btn.addEventListener('click', hideModal);
});
